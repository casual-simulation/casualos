...
Gets the position that the player's camera is at in the given portal.

The **first parameter** is optional and is the portal that the camera position should be retrieved for.
If not specified, then the position of the camera in the `page` portal will be returned.
Possible values are `page` and `inventory`.
...
Gets the rotation that the player's camera is at in the given portal.

The **first parameter** is optional and is the portal that the camera rotation should be retrieved for.
If not specified, then the rotation of the camera in the `page` portal will be returned.
Possible values are `page` and `inventory`.
...
If not specified, then the position of the `mouse` pointer is returned. Possible values are `mouse`, `left`, and `right`.
...
If not specified, then the rotation of the `mouse` pointer is returned. Possible values are `mouse`, `left`, and `right`.
