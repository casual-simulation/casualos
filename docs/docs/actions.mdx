...
<FunctionCode name='showUploadUniverse'/>

Shows the "Upload Universe" dialog which lets the user select a `.aux` file to upload to the universe.

#### Examples:

1. Show the "Upload Universe" dialog.
```typescript
player.showUploadUniverse();
```
