...
Stores the given file data in the given record using the given options for the file.
...
Downloads the file at the given URL or at the URL that was specified in the given <ActionLink action='os.recordFile(recordKey, fileData, options?)' /> result.
