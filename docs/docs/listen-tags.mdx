...
An example of this happening is when another player disconnects. Even though their player bots were not destroyed, they still need to be removed from the server.
