...
A shout that is sent when a universe is loaded.
Sent to every universe that is loaded.
...
A shout that is sent when a universe is unloaded.
Sent to every universe that is loaded.
...
A shout that is sent when a universe is connected and fully synced.
Sent to every universe that is loaded.
...
A shout that is sent when a universe has been temporarily disconnected from the server.
Sent to every universe that is loaded.
...
A shout that is sent when some text is pasted into the universe.
