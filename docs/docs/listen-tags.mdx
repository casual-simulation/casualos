...
Only sent for bots that have one of <TagLink tag='@onMaxLODEnter'/>,  <TagLink tag='@onMaxLODExit'/>, <TagLink tag='@onMinLODEnter'/>, <TagLink tag='@onMinLODExit'/>, <TagLink tag='maxLODThreshold'/> or <TagLink tag='auxMinLODThreshold'/> specified.
