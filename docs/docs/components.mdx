...
export const GridPortalBadge = ({url}) => (<Badge type='normal' title='This tag is available on the grid portal bot.'>gridPortalBot</Badge>);
export const MiniGridPortalBadge = ({url}) => (<Badge type='normal' title='This tag is available on the miniGridPortal bot.'>miniGridPortalBot</Badge>);
