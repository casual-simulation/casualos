...
export const MiniPortalBadge = ({url}) => (<Badge type='normal' title='This tag is available on the mini portal bot.'>miniPortalBot</Badge>);
export const MapPortalBadge = ({url}) => (<Badge type='normal' title='This tag is available on the map portal bot.'>mapPortalBot</Badge>);
