...
When a new instance of CasualOS is opened, the screen should display a relatively empty screen with a spinning <GlossaryRef term='bot'>bot</GlossaryRef> known and reffered to as <GlossaryRef term='ab-1'>ab-1</GlossaryRef>.
