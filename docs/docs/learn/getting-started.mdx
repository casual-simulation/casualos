...
import { Article } from '../components/stylingTools.jsx';
 

<Article imageStyle={{padding:"2rem"}} />
...
When a new instance of CasualOS is opened, the screen should display a relatively empty screen with a spinning <GlossaryRef term='bot'>bot</GlossaryRef> known as and reffered to in docs as <GlossaryRef term='ab-1'>ab-1</GlossaryRef>.

The image below shows the screen you should see upon launcing a CasualOS <GlossaryRef term='instance'>instance</GlossaryRef>.

![CasualOS](../../static/img/intro/casualos_start.png)

The blank slate that the cube shaped bot is sitting on is what is known as the `gridPortal`. The `gridPortal` is a 3D view that uses things called <GlossaryRef term='bot'>bots</GlossaryRef> as its visual and functional components.
