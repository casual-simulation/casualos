...
2. Set the `botPortal` to "myDimension".
```typescript
configBot.tags.botPortal = "myDimension";
```

### `botPortalBot`

The bot that is used to configure the <TagLink tag='botPortal'>bot portal</TagLink>.
...
1. Set the bot portal color to "blue".
```typescript
botPortalBot.tags.portalColor = "blue";
```
...
The bot that should be used to configure the <TagLink tag='miniPortal'>mini portal</TagLink>.
