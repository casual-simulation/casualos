...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='iframe'>
    A website loaded into an iframe.
  </PossibleValueCode>
</PossibleValuesTable>
...
When <TagLink tag='auxForm'/> is set to `iframe`, the address should be the URL of the website that should be displayed.
