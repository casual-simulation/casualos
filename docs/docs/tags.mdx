...
The width of the grid portal in pixels. Because the mini portal is contained by the grid portal, this value also applies to the mini portal.
...
The height of the grid portal in pixels. Because the mini portal is contained by the grid portal, this value also applies to the mini portal.
