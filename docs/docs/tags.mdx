...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='poly'>
    A mesh loaded from <a href="https://poly.google.com">poly.google.com</a>.
    Requres the <TagLink tag='polyApiKey'/> tag to be set on the config bot.
  </PossibleValueCode>
</PossibleValuesTable>
...
It also means that putting `auxInventoryPortal=myDimension` into the query string will set the <TagLink tag='auxInventoryPortal'/> tag to `myDimension`.
...
The [API Key][api-key] that should be used to access the [poly.google.com](https://poly.google.com) [API](https://developers.google.com/poly).
Must be placed on the config bot to work.

You can get an API Key by following the "Get an API Key" instructions on the [Poly developers website](https://developers.google.com/poly/develop/web#get_an_api_key).
...
The Stripe publishable [API Key][api-key] that should be used for checkouts.
Must be placed on the config bot to work.

Because this key is meant to be public, you should place this in the universe that you call <ActionLink action='player.checkout(options)'/> from.

See the [Stripe documentation](https://stripe.com/docs/keys) for more information.
...
The Stripe secret [API Key][api-key] that should be used to finish checkouts.
Must be placed on the config bot to work.

Because this key is meant to be private, you should place this in the processing universe that was specified
in the call to <ActionLink action='player.checkout(options)'/>.
