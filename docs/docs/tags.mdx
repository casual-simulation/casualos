...
Because this key is meant to be public, you should place this in the universe that you call
<ActionLink action='player.checkout(options)'/> from.
...
by the call to <ActionLink action='player.checkout(options)'/>.
