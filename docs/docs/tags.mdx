...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='codeButton'>
    <p>
        The bot will appear as a clickable button in the multi-line editor when placed in the same the same dimension that the tag portal uses
        for the button to appear. The bot will also need a label in order to appear.
    </p>
    <p>
