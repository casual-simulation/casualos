...
The ID of the bot that should transform this bot in the bot and mini portals.
...
When set on a portal bot (like `botPortalBot`), this will transform the portal camera by the specified bot.
...
Because the bot and mini portals use [polar coordinates](https://en.wikipedia.org/wiki/Polar_coordinate_system) to orbit around the focus point, we only need two numbers to specify where the camera should be pointing.
...
Set this tag to `true` on the bot portal to fix rendering issues with 3D models that use alpha cutoff.
...
#### Possible values are:
<PossibleValuesTable>
  <PossibleValueCode value='Bot Portal'>
    "Bot Portal" (Default)
  </PossibleValueCode>
  <PossibleValue value='Any String'>
    The text that should be displayed as a hint when the user hovers their mouse over the button.
...
The width of the bot portal in pixels. Because the mini portal is contained by the bot portal, this value also applies to the mini portal.
...
The height of the bot portal in pixels. Because the mini portal is contained by the bot portal, this value also applies to the mini portal.
...
The X position of the player's camera in the bot portal.
...
The Y position of the player's camera in the bot portal.
...
The Z position of the player's camera in the bot portal.
...
The offset that should be applied to the X position of the player's camera in the bot portal.
...
The offset that should be applied to the Y position of the player's camera in the bot portal.
...
The offset that should be applied to the Z position of the player's camera in the bot portal.
...
The X rotation of the player's camera in the bot portal.
...
The Y rotation of the player's camera in the bot portal.
...
The Z rotation of the player's camera in the bot portal.
...
The offset that should be applied to the X rotation of the player's camera in the bot portal.
...
The offset that should be applied to the Y rotation of the player's camera in the bot portal.
...
The offset that should be applied to the Z rotation of the player's camera in the bot portal.
...
The X position of the focus point for the player's camera in the bot portal.
...
The Y position of the focus point for the player's camera in the bot portal.
...
The Z position of the focus point for the player's camera in the bot portal.
...
The dimension that is loaded into the "bot" portal in CasualOS.
...
This can be used with <TagLink tag='form'/> and <TagLink tag='formAddress'/> to display the avatar in the bot or mini portals.
