...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='codeButton'>
    The bot will appear as a clickable button in the multi-line editor.
    You also need to place the bot in the same dimension that the tag portal uses
...
<PossibleValuesTable>
  <PossibleValueCode value='light'>
    CasualOS is displayed with a white-like-paper color theme. (Default)
  </PossibleValueCode>
  <PossibleValueCode value='dark'>
