...
The cursor that should be used when the mouse pointer is hovering over the bot in the page and menu portals.
...
The ID of the bot that should transform this bot in the page and mini portals.
...
Whether the player will be able to rotate the camera inside the mini portal.

#### Possible values are:
<PossibleValuesTable>
  <PossibleValueCode value='true'>
    The mini portal is rotatable. (Default)
  </PossibleValueCode>
  <PossibleValueCode value='false'>
    The mini portal is not rotatable.
  </PossibleValueCode>
</PossibleValuesTable>
...
Because the page and mini portals use [polar coordinates](https://en.wikipedia.org/wiki/Polar_coordinate_system) to orbit around the focus point, we only need two numbers to specify where the camera should be pointing.
...
Sets the initial height of the viewport for the mini portal.

This should be the percentage of the "available screen height" that the mini portal should take.
...
there will be some space at the bottom of the mini portal. However, when the <TagLink tag='miniPortalWidth'/> tag is set to 1, there will be no space between the bottom
of the screen and the bottom of the mini portal.

#### Possible values are:
<PossibleValuesTable>
  <PossibleValue value='Numbers >= 0 and <= 1'>
    The percentage of the screen height that the mini portal should take. (Default is 0.2)
  </PossibleValue>
</PossibleValuesTable>
...
Sets the width of the viewport for the mini portal.
This should be a percentage between 0 and 1 that specifies how much of the screen width should be taken.

#### Possible values are:
<PossibleValuesTable>
  <PossibleValue value='Numbers >= 0 and <= 1'>
    The percentage of the screen width that the mini portal should take. (Default is 0.8)
  </PossibleValue>
</PossibleValuesTable>
...
Whether the player will be able to resize the viewport for the mini portal.

#### Possible values are:
<PossibleValuesTable>
  <PossibleValueCode value='true'>
    The mini portal is resizable. (Default)
  </PossibleValueCode>
  <PossibleValueCode value='false'>
    The mini portal is not resizable.
  </PossibleValueCode>
</PossibleValuesTable>
...
Sets the style of the bottom layer of the map in the map portal.
...
The width of the page portal in pixels. Because the mini portal is contained by the page portal, this value also applies to the mini portal.
...
The height of the page portal in pixels. Because the mini portal is contained by the page portal, this value also applies to the mini portal.
...
It also means that putting `miniPortal=myDimension` into the query string will set the <TagLink tag='miniPortal'/> tag to `myDimension`.
...
The token that is used to verify that the user is authenticated for the app bundle that was automatically loaded.
Only available on the auth bot.

### `authBundle`

The name of the app bundle that the auth bot was created for.
Only available on the auth bot.

### `avatarAddress`

The address that the user's avatar mesh can be found at.
This can be used with <TagLink tag='form'/> and <TagLink tag='formAddress'/> to display the avatar in the page or mini portals.
