...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='<vertical> <horizontal>'>
    The label is sized taking into account the vertical padding (first number) and horizontal padding (second number) when two numbers are separated by a space.
  </PossibleValueCode>
</PossibleValuesTable>
