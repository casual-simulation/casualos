...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='player'>
    The bot is not saved and is shared with everyone else.
    Bots in this space show up in the `otherPlayers` space to other players.
  ...
  <PossibleValueCode value='otherPlayers'>
    The bot is not saved and is shared with everyone else.
    Bots appear in this space when another player puts a bot in their `player` space.
    Only the other player's session can create, edit, and destroy bots in this space.
    When the other player's session is closed, the bot is destroyed.
  </PossibleValueCode>
...
Available on `pagePortalBot` and `inventoryPortalBot`.
...
Available on `inventoryPortalBot`.
...
Available on `leftWristPortalBot` and `rightWristPortalBot`.
...
Whether the bot is in the `error` dimension.
...
## Page Portal Bot Tags

These are tags that are on the page portal bot.
Most of them are automatically set by the page portal but some of them (like the `pageCameraPositionOffset` tags) can be changed manually.
...
## Inventory Portal Bot Tags

These are tags that are on the page portal bot.
Most of them are automatically set by the page portal but some of them (like the `inventoryCameraPositionOffset` tags) can be changed manually.

### `inventoryCameraPositionX`

The X position of the player's camera in the inventory portal.

### `inventoryCameraPositionY`

The Y position of the player's camera in the inventory portal.

### `inventoryCameraPositionZ`

The Z position of the player's camera in the inventory portal.

### `inventoryCameraPositionOffsetX`

The offset that should be applied to the X position of the player's camera in the inventory portal.

### `inventoryCameraPositionOffsetY`

The offset that should be applied to the Y position of the player's camera in the inventory portal.

### `inventoryCameraPositionOffsetZ`

The offset that should be applied to the Z position of the player's camera in the inventory portal.

### `inventoryCameraRotationX`

The X rotation of the player's camera in the inventory portal.

### `inventoryCameraRotationY`

The Y rotation of the player's camera in the inventory portal.

### `inventoryCameraRotationZ`

The Z rotation of the player's camera in the inventory portal.

### `inventoryCameraRotationOffsetX`

The offset that should be applied to the X rotation of the player's camera in the inventory portal.

Units are in radians.

### `inventoryCameraRotationOffsetY`

The offset that should be applied to the Y rotation of the player's camera in the inventory portal.

Units are in radians.

### `inventoryCameraRotationOffsetZ`

The offset that should be applied to the Z rotation of the player's camera in the inventory portal.
