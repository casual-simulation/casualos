...
When CasualOS runs across a vector tag, it parses the numbers and converts it into a [`Vector2`](/math/vectors#vector2) or [`Vector3`](/math/vectors#vector3) object depending on if it contains 2 or 3 numbers.
...
See the documentation on [Vectors](/math/vectors) for more information and examples for scripting.
...
When CasualOS runs across a rotation tag, it parses the numbers and converts it into a [`Rotation`](/math/rotations#rotation) object.
...
See the documentation on [Rotations](/math/rotations) for more information and examples for scripting.
