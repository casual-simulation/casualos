...
When set, the `config` variable will be available in scripts as a shortcut to the specified bot.
...
1. Open the tag portal for the `abc` tag on the player bot.
```typescript
...
The width of the page and inventory portals in pixels.
...
The height of the page and inventory portals in pixels.
