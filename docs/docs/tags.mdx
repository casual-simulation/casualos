...
Needs both auxProgressBarBackgroundColor and progressBarColor to visualize the progress
...
<PossibleValuesTable>
  <PossibleValue value='Numbers >= 0 and <= 1'>
    <ul>
      ...
      <li>
        0.5 means that you will see half of <TagLink tag='auxProgressBarBackgroundColor'/> and half of <TagLink tag='progressBarColor'/>.
      </li>
      <li>
