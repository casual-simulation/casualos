...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='codeButton'>
    ...
    The X position of the bot translates to the line number that the button should appear at, and the Y position specifies the priority of the button compared to other buttons on the same line (larger numbers indicate lower priorities).
  </PossibleValueCode>
