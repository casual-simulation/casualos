...
<PossibleValuesTable>
  ...
  <PossibleValueCode value='pointLight'>
    A bot with the form <TagLink tag='light'/> will appear as a pointlight
  </PossibleValueCode>
  <PossibleValueCode value='ambientLight'>
    A bot with the form <TagLink tag='light'/> will appear as an ambientLight
  </PossibleValueCode>
  <PossibleValueCode value='directionalLight'>
    A bot with the form <TagLink tag='light'/> will appear as a directionalLight
  </PossibleValueCode>
  <PossibleValueCode value='spotLight'>
    A bot with the form <TagLink tag='light'/> will appear as a spotLight
  </PossibleValueCode>
  <PossibleValueCode value='hemisphereLight'>
    A bot with the form <TagLink tag='light'/> will appear as a hemisphereLight
  </PossibleValueCode>
</PossibleValuesTable>
