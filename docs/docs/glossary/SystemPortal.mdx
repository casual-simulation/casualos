...
It can be opened by setting the <TagLink tag='systemPortal'/> tag on the <VariableLink name='configBot'/> to `true`.
Additionally, it can also be opened by holding down the <kbd>Shift</kbd> key, clicking <GlossaryRef term="abCore"/>, and then selecting "systemPortal".
