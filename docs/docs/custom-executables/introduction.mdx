...
Unlike [Listen Tags](../listen-tags/tags.mdx), Custom executables allow you to access the [Web Browser DOM](https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model) to create experiences.
