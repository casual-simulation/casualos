...
The bot that is used to configure the <TagLink tag='gridPortal'>grid portal</TagLink>.
...
- <TagLink tag='portalCameraRotationX'/>
- <TagLink tag='portalCameraRotationY'/>
...
The bot that should be used to configure the <TagLink tag='miniGridPortal'>miniGridPortal</TagLink>.
...
The bot that should be used to configure the <TagLink tag='mapPortal'>map portal</TagLink>.
