...
![CasualOS](/img/intro/casualos_start.png)
...
The way to start a new instance is to go to the related link. In my case I’ll be using [casualos.com](https://casualos.com) but you may be using [ab1.bot](https://ab1.bot) or [publicos.com](https://publicos.com).
...
![URL Bar Showing Auto-Generated inst name](/img/intro/casualos_url.png)
...
-   `gridPortal`
    -   The `gridPortal` is a window that allows the users to view bots oftentimes as colored boxes floating in space.
        ...
        ![Image of grid portal](/img/intro/gridPortal.png)
...
-   `sheetPortal`
    -   The `sheetPortal` is a window almost like an excel sheet that shows each of the bots and their related tags in a given context or dimension as they are called.
        ...
        ![Image of sheet portal](/img/intro/sheetPortal.png)
...
-   `menuPortal`
    -   The menuPortal is a collection of bots in the form of [HTML divs](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/div) that hover over the `pagePortal`.
        ...
        ![Image of menu portal](/img/intro/menuPortal.png)
...
![Image of bots in sheet portal](/img/intro/botsInSheetPortal.png)
...
![Image showing tags in sheet portal](/img/intro/sheetPortalTags.png)
...
![URL Bar Showing Sheet Portal = home](/img/intro/casualos_sheetPortalUrl.png)
...
![Image showing sheet portal with one bot with home = true and other bot with home = here](/img/intro/casualos_sheetPortalDimensions.png)
...
![Image of ab-1](/img/intro/ab-1.png)
...
![Image of ab-1's bot menu](/img/intro/ab-1_selectMenu.png)
...
![Image of ab-1's bot menu](/img/intro/ab-1_mainMenu.png)