module.exports = {
    ...
    transformIgnorePatterns: [
        '/node_modules/\\.pnpm/(?!livekit-server-sdk|@sveltejs\\+acorn-typescript|@livekit\\+protocol|camelcase-keys|map-obj|camelcase|quick-lru|parse5|uuid|@zip\\.js\\+zip\\.js).+\\.js$',
    ],
    snapshotFormat: {
        escapeString: true,
