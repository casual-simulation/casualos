...
describe('diffLinesUnified edge cases', () => {
    test('a empty string b empty string', () => {
        ...
        const received = diffLinesUnified(
            a.split('\n'),
            b.split('\n'),
            optionsBe
        );
...
describe('options', () => {
    ...
    describe('change color', () => {
        ...
        test('diffStringsUnified', () => {
            ...
            expect(
                diffStringsUnified(aChanged, bChanged, options)
            ).toMatchSnapshot();
        });
    ...
    describe('includeChangeCounts false', () => {
        ...
        test('diffStringsUnified', () => {
            expect(
                diffStringsUnified(aString, bString, options)
            ).toMatchSnapshot();
        });
    });
    ...
    describe('omitAnnotationLines true', () => {
        ...
        test('diffStringsUnified and includeChangeCounts true', () => {
            ...
            expect(
                diffStringsUnified(aString, bString, options2)
            ).toMatchSnapshot();
        });
    ...
    describe('trailingSpaceFormatter', () => {
        ...
        test('diff middle dot', () => {
            ...
            expect(
                diff(aTrailingSpaces, bTrailingSpaces, options)
            ).toMatchSnapshot();
        });
