...
describe('Immutable.List', () => {
    ...
    it('supports a single string element', () => {
        expect(Immutable.List(['foo'])).toPrettyPrintTo(
            'Immutable.List ["foo"]',
            {
                min: true,
            }
...
describe('Immutable.Set', () => {
    ...
    it('supports a single string element', () => {
        expect(Immutable.Set(['foo'])).toPrettyPrintTo(
            'Immutable.Set ["foo"]',
            {
                min: true,
            }
...
describe('Immutable.Map', () => {
    ...
    it('supports an object with single key', () => {
        expect(Immutable.Map({ a: 1 })).toPrettyPrintTo(
            'Immutable.Map {"a": 1}',
            {
                min: true,
            }
...
describe('Immutable.Seq', () => {
    it('supports an empty sequence from array {min: true}', () => {
        expect(Immutable.Seq([])).toPrettyPrintTo('Immutable.Seq []', {
            min: true,
        });
    });
