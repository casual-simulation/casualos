...
CREATE TABLE "SubscriptionPeriod" (
    ...
    "periodStart" DECIMAL NOT NULL,
    "periodEnd" DECIMAL NOT NULL,
    "createdAt" DECIMAL NOT NULL,
    "updatedAt" DECIMAL NOT NULL,
