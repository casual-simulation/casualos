...
const TRACE_NAME = 'PrismaDatabaseRecordsStore';

export class PrismaDatabaseRecordsStore implements DatabaseRecordsStore {
    ...
    async listItemsByMarker(
        ...
        let query: Prisma.DatabaseRecordWhereInput = {
