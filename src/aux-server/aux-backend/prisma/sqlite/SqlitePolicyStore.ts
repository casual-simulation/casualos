...
export class SqlitePolicyStore implements PolicyStore {
    ...
    private _convertEntitlement(
        ...
        return {
            ...
            expireTimeMs: e.expireTime?.toNumber(),
            revokeTimeMs: e.revokeTime?.toNumber(),
            createdAtMs: e.createdAt?.toNumber(),
        };
    }
    ...
    async assignPermissionToSubjectAndResource(
        ...
        return {
            ...
            permissionAssignment: {
                ...
                expireTimeMs: result.expireTime?.toNumber(),
            },
        };
    }
    ...
    async listPermissionsInRecord(
        ...
        return {
            ...
            resourceAssignments: resourcePermissions.map((p) => ({
                ...
                userId: p.userId,
                expireTimeMs: p.expireTime?.toNumber(),
            })),
    ...
    async listRolesForUser(
        ...
        return assignments.map(
            (r) =>
                ({
                    role: r.roleId,
                    expireTimeMs: getExpireTime(r.expireTime?.toNumber()),
                } as AssignedRole)
        );
    }
        ...
        const results = assignments.map((a) => {
            if (a.type === 'inst') {
                return {
                    ...
                    role: {
                        role: a.roleId,
                        expireTimeMs: getExpireTime(a.expireTime?.toNumber()),
                    },
                } as const;
            } else {
                return {
