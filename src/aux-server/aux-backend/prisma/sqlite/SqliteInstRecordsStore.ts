...
const TRACE_NAME = 'SqliteInstRecordsStore';

/**
 * Defines an inst records store that uses Prisma to store records.
 */
export class SqliteInstRecordsStore implements InstRecordsStore {
    ...
    async addUpdates(
        ...
        throw new Error(
            'addUpdates() is not implemented for SqliteInstRecordsStore. Use replaceCurrentUpdates() instead.'
        );
    }
