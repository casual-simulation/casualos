...
const TRACE_NAME = 'PrismaSharedPermissionsStore';

/**
 * Implements SharedPermissionsStore for Prisma (CockroachDB).
 */
export class PrismaSharedPermissionsStore implements SharedPermissionsStore {
    ...
    async saveSharedPermission(
        ...
        await this._client.sharedPermission.upsert({
            ...
            create: {
                ...
                createdAt: convertToDate(sharedPermission.createdAtMs),
                updatedAt: convertToDate(sharedPermission.updatedAtMs),
                expireTime: convertToDate(sharedPermission.expireTimeMs),
    ...
    private _convert(p: PrismaSharedPermission): SharedPermission {
        ...
        return {
            ...
            createdAtMs: convertToMillis(p.createdAt),
            updatedAtMs: convertToMillis(p.updatedAt),
