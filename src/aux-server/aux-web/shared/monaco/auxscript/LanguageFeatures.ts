...
import type { AuxScriptBackend } from './AuxScriptBackend';
import { LanguageServiceDefaults } from './LanguageServiceDefaults';
import {
    editor,
    languages,
    Uri,
    ...
    MarkerTag,
    MarkerSeverity,
} from '@casual-simulation/monaco-editor';
...
export abstract class Adapter {
    constructor(
        protected _worker: (...uris: Uri[]) => Promise<AuxScriptBackend>
    ) {}
...
export class DiagnosticsAdapter extends Adapter {
    ...
    constructor(
        ...
        worker: (...uris: Uri[]) => Promise<AuxScriptBackend>
    ) {
        super(worker);
