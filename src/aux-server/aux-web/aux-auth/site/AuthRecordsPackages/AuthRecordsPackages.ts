...
export default class AuthRecordsPackages extends Vue {
    private _helper: LoadingHelper<PackageRecord>;
    ...
    selectedItem: PackageRecord = null;
    ...
    onSelectItem(item: PackageRecord) {
        this.selectedItem = item;
    }

    async deletePackage(item: PackageRecord) {
        const result = await authManager.client.erasePackage({
            recordName: this.recordName,
